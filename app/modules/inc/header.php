					...
					<div class="menu-nav__inner">
						<div class="menu-nav__top-wrap">
							...
							<div class="menu-text-wrap">
								<h2 class="menu-text"><?=$mes['Меню']?></h2>
							</div>
							<!--/END menu-text-wrap-->
							...
							<div class="menu-nav__center-item">
								<div class="about">
									<ul class="about__list">
										<li class="menu-nav__heading"><?= $mes['menu-heading1']?></li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd()?>"><?= $mes['menu-item1'] ?></a>
										</li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd('apartment')?>"><?= $mes['menu-item2'] ?></a>
										</li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd('house')?>"><?= $mes['menu-item3'] ?></a>
										</li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd('architecture')?>"><?= $mes['menu-item4'] ?></a>
										</li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd('advantage')?>"><?= $mes['menu-item5'] ?></a>
										</li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd('location')?>"><?= $mes['menu-item6'] ?></a>
										</li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd('values')?>"><?= $mes['menu-item7'] ?></a>
										</li>
										<li class="about__item"><a class="menu-nav__link" href="<?=UrlAdd('contact')?>"><?= $mes['menu-item8'] ?></a>
										</li>
									</ul>
								</div>
								<!--/END about-->
							...
							<div class="menu-nav__center-item">
								<div class="apartment">
									...
									<li class="apartment__item">
											<a class="menu-nav__link" href="<?=UrlAdd('apartment')?>"><?= $mes['За планом'] ?></a>
										</li>
									<li class="apartment__item">
								...
								<div class="project">
									<ul class="project__list">
										...
										<li class="project__item">
											<a class="menu-nav__link" href="<?=UrlAdd('construction')?>"><?= $mes['menu-construction'] ?></a>
										</li>
										...
										<li class="project__item">
											<a class="menu-nav__link" href="<?=UrlAdd('construction')?>">Будівництво</a>
										</li>
									</ul>
								</div>
								<!--/END project-->
								...
								<div class="document-info">
									<ul class="document-info__list">
										...
										<li class="document-info">
											<!-- <a class="menu-nav__link" href="404.html">Документація</a> -->
							...
							<div class="menu-nav__center-item">
								...
								<div class="for-sale">
									<ul class="for-sale__list">
										...
										<li class="for-sale__item" data-main__bot-item="1">
											<!-- <a href="#" class="for-sale__link">вул. Володимирська, 86А</a> -->
											<a href="#" class="for-sale__link"><?=$mes['adres']?></a>
										</li>
										<li class="for-sale__item" data-main__bot-item="2">
											<!-- <a href="#" class="for-sale__link">Льва Толстого</a> -->
