...
$this->fontdata = array(
	...
	"pfdintexttniversal" => array(
		'R' => "PFDinTextUniversal-Thin.ttf",
		'B' => "PFDinTextUniversal-Thin.ttf",
		'I' => "PFDinTextUniversal-Thin.ttf",
		'BI' => "PFDinTextUniversal-Thin.ttf",
		),
	"pfdintexttniversalmedium" => array(
		'R' => "PFDinTextUniversal-Medium.ttf",
		'B' => "PFDinTextUniversal-Medium.ttf",
		'I' => "PFDinTextUniversal-Medium.ttf",
		'BI' => "PFDinTextUniversal-Medium.ttf",
		),
	"pfdintexttniversalreg" => array(
		'R' => "PFDinTextUniversal-Regular.ttf",
		'B' => "PFDinTextUniversal-Regular.ttf",
		'I' => "PFDinTextUniversal-Regular.ttf",
		'BI' => "PFDinTextUniversal-Regular.ttf",
		),
	...
	"gothammedium" => array(
		'R' => "CynthoPro-Regular.ttf",
		'B' => "CynthoPro-Bold.ttf",
		'I' => "CynthoPro-Italic.ttf",
		'BI' => "CynthoPro-BoldItalic.ttf",
		),
	"roboto" => array(
		'R' => "RobotoRegular.ttf",
		'B' => "RobotoBold.ttf",
...
$this->mono_fonts = array('dejavusansmono','mono','monospace','freemono','pfdintexttniversal','pfdintexttniversalreg','pfdintexttniversalmedium','gothamreg','gothammedium','roboto','cynthopro','schlbki','akzidenzgroteskpro','liberationmono','courier', 'ocrb','ocr-b','lucidaconsole',
